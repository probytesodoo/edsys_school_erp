...
class product_category(models.Model):
    ...
    property_account_creditor_price_difference_categ = fields.Many2one(relation='account.account',
            string="Price Difference Account",
            help="This account will be used to value price difference between purchase price and cost price.")

        #Redefine fields to change help text for anglo saxon methodology.            
    property_account_income_categ = fields.Many2one(relation='account.account',
