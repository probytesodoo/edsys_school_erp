    ...
    def get(self, model=None, id=None, **payload):
        ...
        if model:
            ...
            if data:
                ...
                return valid_response(data)
        return {'message': 'The model %s is not available in the registry.' % ioc_name}#invalid_response('invalid object model', 'The model %s is not available in the registry.' % ioc_name)
