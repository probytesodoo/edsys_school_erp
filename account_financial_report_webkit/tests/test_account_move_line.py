...
class TestAccountMoveLine(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.line_1 = self.move_1.line_ids.sorted(lambda l: l.id)[0]
    ...
    def test_01_last_rec_date(self):
        ...
        self.line_2 = self.move_2.line_ids.sorted(lambda l: l.id)[0]

        self.reconcile = self.env['account.move.reconcile'].create({
            'name': 'A999',
            'type': 'auto',
            'line_ids': [(4, self.line_1.id), (4, self.line_2.id)]
        })
    ...
    def test_02_last_rec_date_with_partial_reconcile(self):
        ...
        self.line_3 = self.move_3.line_ids.sorted(lambda l: l.id)[0]
