...
var WeekHeadColor = "#0000FF"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#A9A9A9"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#A9A9A9"; //Background color of Saturday.
var WeekDayColor = "#D3D3D3"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#7CACFA"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#0000FF"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
var YrSelColor = "#cc0033"; //color of font of Year selector.
var MthSelColor = "#cc0033"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#blue"; //color when mouse move over.
...
var imageFilesPath = "/edsys_hrm/static/description/";
...
function RenderCssCal(bNewCal)
{
	...
	else //if not to show time.
	{
	    ...
	    //close button
	    if (UseImageFiles) {
	        vCalClosing += "<img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\"); stopSpin();' src='../edsys_hrm/static/description/cal_close.gif' width='16px' height='14px' onmouseover='changeBorder(this,0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>";
	    }
	    else {
