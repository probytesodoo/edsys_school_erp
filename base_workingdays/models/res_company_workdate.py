...
class ResCompanyWorkdate(models.Model):
    ...
    company_id = fields.Many2one('res.company', string='Company', default=lambda self: self.env['res.company']._company_default_get('res.company.workdate'), help='Company for this working date')
